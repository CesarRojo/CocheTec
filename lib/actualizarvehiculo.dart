  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          TextField(decoration: InputDecoration(labelText: "PLACA"),controller: placaController),
          SizedBox(height: 10,),
          TextField(decoration: InputDecoration(labelText: "TIPO"), controller: tipoController),
          SizedBox(height: 10,),
          TextField(decoration: InputDecoration(labelText: "NUMERO SERIE"), controller: numeroserieController),
          SizedBox(height: 10,),
